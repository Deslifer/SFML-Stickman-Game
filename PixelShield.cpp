...
PixelShield::PixelShield(b2World* world, sf::Sprite sprite, float x, float y, b2BodyType type, float size,b2Body* player)
	:Pixel(world,sprite, x, y, type, size)
{
	...
	this->mDef.maxForce = 1 * this->sprite.getScale().x;
